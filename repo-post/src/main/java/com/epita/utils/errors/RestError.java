...
public enum RestError {
    POST_NOT_FOUND(404, "Post with ID %s not found"), BAD_REQUEST(400, "Invalid request"), INTERNAL_SERVER_ERROR(500, "Internal server error"), MISSING_FIELD(400, "missing field: %s"), // FIXME
